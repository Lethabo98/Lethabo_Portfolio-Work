...
function checkAnswer(guess){
    if(attempts <= 3){
        if(guess === secretNumber){
            displayOutput.innerHTML = "Good! Your number " + guess + " is correct.";
        }else if(guess < secretNumber){
            displayOutput.innerHTML = "Wrong! Your number " + guess + " is too low."
            clearInput();
        }else if(guess > secretNumber){
            displayOutput.innerHTML = "Wrong! Your number " + guess + " is too high."
            clearInput();
        }else{
